...
const USAGE = `Usage: herdr-visual-lab [start] [--port <n>] [--no-open] [--fixture <${FIXTURE_NAMES.join('|')}>] [--socket <path>] [--speed <n>]`;
...
export async function run(argv: string[]): Promise<void> {
  ...
  console.log(
    `Herdr Visual Lab · ${url}${options.fixture ? ` · fixture: ${options.fixture}` : ''}` +
