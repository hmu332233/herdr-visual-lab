...
export const unitJoined=(id='t1',teamID='ws',status:'idle'|'working'|'done'|'blocked'='working',sourceOrder=0,stableOrder=0):GameEventBody=>({kind:'unit-joined',unit:{id,teamID,tabLabel:id,agentKind:'codex',status,isFocused:false,sourceOrder,stableOrder}});
